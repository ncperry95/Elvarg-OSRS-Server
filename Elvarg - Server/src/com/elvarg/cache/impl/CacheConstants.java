...
public class CacheConstants {
    ...
    /**
     * Represents the id of the word archive - used for storing profane or
     ...
     */
    public static final String DATA_PREFIX = "main_file_cache.dat2";
     ...
     */
    public static final String CACHE_BASE_DIR = "./Elvarg - Server/data/cache/";
